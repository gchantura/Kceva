...
<main class="min-h-screen bg-gray-50">
  {#if category}
    <!-- Category Header - Fixed Background Image -->
    <div class="relative bg-gray-900 text-white overflow-hidden">
      <div class="absolute inset-0">
        ...
        />
        <!-- Additional overlay to ensure the image doesn't bleed -->
        ...
        <div class="text-center py-16">
          ...
          >
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2M4 13h2m0 0v6h4v-6m0 0h8v6h4v-6"
            ></path>
          </svg>
