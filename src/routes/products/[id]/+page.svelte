          ...
          <ol class="flex items-center space-x-4">
            ...
            <li>
              <a
                ...
                class="text-gray-400 hover:text-gray-600 capitalize"
                >{product.category.replace("-", " ")}</a
              >
            </li>
            <li>
              <svg
        ...
        <div class="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
          ...
          <div class="mt-4">
            <div class="flex items-center">
              ...
              {#if product.originalPrice > product.price}
                ...
                >
                <span
                  class="ml-2 bg-red-100 text-red-800 text-sm font-medium px-2.5 py-0.5 rounded"
                >
          ...
          >
            <p class="text-xs text-yellow-800">
              <strong>Affiliate Disclosure:</strong> We may earn a commission from
              qualifying purchases made through our affiliate links. This comes at
              no additional cost to you and helps support our website.
            </p>
          </div>
        </div>
      </div>
